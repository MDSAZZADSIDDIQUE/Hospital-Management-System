...
namespace Hospital_Management_System
{
    public partial class FormAddEmployee : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            sqlConnection.Open();
            SqlCommand sqlCommand = new SqlCommand("Insert into Employees (UserRole, FirstName, LastName, ID, EmailAddress, Password, MobileNo, Sex, Address, Status) values ('" + employee.UserRole + "','" + employee.FirstName + "','" + employee.LastName + "','" + employee.ID + "','" + employee.EmailAddress + "','" + employee.Password + "','" + employee.MobileNo + "','" + employee.Sex + "','" + employee.Address + "','" + employee.Status + "')", sqlConnection);
