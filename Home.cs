...
namespace Hospital_Management_System
{
    public partial class Home : Form
    {
        ...
        public Home()
        {
            ...
            customizeDesign();
            openChildForm(new ShowDashboard());
        }
        ...
        private void btnAddPatient_Click(object sender, EventArgs e)
        {
            ...
            lblHome.Text = btnAddPatient.Tag.ToString();
        ...
        private void btnPatientList_Click(object sender, EventArgs e)
        {
            ...
            lblHome.Text = btnPatientList.Tag.ToString();
        ...
        {
            lblHome.Text = btnAddBill.Tag.ToString();
            openChildForm(new FormAddBill());
        }

        private void btnBillList_Click(object sender, EventArgs e)
        {
            lblHome.Text = btnBillList.Tag.ToString();
        ...
        {
            lblHome.Text = btnAddEmployee.Tag.ToString();
            openChildForm(new FormAddEmployee());
        }

        private void btnEmployeeList_Click(object sender, EventArgs e)
        {
            lblHome.Text = btnEmployeeList.Tag.ToString();
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            if (userRole == "Doctor")
            {
                ...
                btnBilling.Hide();
                panelBilling.Hide();
                btnHumanResources.Hide();
                panelHumanResources.Hide();
            }
        ...
        private void DoctorsCount_Click(object sender, EventArgs e)
        {
